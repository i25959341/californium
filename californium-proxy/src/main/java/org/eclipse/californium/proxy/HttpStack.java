...
public class HttpStack {
	 ...
	 */
	public HttpStack(int httpPort) throws IOException, UnrecoverableKeyException, KeyManagementException, KeyStoreException, NoSuchAlgorithmException, CertificateException {
		new HttpServer(httpPort);
	}

	public HttpStack(int httpPort, String TRUST_STORE_PASSWORD, String KEY_STORE_PASSWORD, String KEY_STORE_LOCATION, String TRUST_STORE_LOCATION ) throws IOException, UnrecoverableKeyException, KeyManagementException, KeyStoreException, NoSuchAlgorithmException, CertificateException {
		new HttpServerSSL(httpPort, TRUST_STORE_PASSWORD,  KEY_STORE_PASSWORD,  KEY_STORE_LOCATION,  TRUST_STORE_LOCATION);
	}
...
//					if (Bench_Help.DO_LOG)
	...
	private class HttpServerSSL {


		public HttpServerSSL(int httpPort, String _TRUST_STORE_PASSWORD, String _KEY_STORE_PASSWORD, String _KEY_STORE_LOCATION, String _TRUST_STORE_LOCATION) throws KeyStoreException, NoSuchAlgorithmException, CertificateException, IOException, UnrecoverableKeyException, KeyManagementException {
			final String TRUST_STORE_PASSWORD = _TRUST_STORE_PASSWORD;
			final String KEY_STORE_PASSWORD = _KEY_STORE_PASSWORD;
			final String KEY_STORE_LOCATION = _KEY_STORE_LOCATION;
			final String TRUST_STORE_LOCATION = _TRUST_STORE_LOCATION;
			...
			NHttpConnectionFactory<DefaultNHttpServerConnection> connFactory = new SSLNHttpServerConnectionFactory(sslcontext, null, params);
