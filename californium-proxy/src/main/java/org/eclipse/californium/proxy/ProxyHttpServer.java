...
public class ProxyHttpServer {
	 ...
	 */
	public ProxyHttpServer(CoapServer server) throws IOException, UnrecoverableKeyException, KeyManagementException, KeyStoreException, NoSuchAlgorithmException, CertificateException {
	 ...
	 * @throws UnrecoverableKeyException
	 */
	public ProxyHttpServer(int httpPort) throws IOException, UnrecoverableKeyException, KeyManagementException, KeyStoreException, NoSuchAlgorithmException, CertificateException {
	...
	public ProxyHttpServer(int httpPort, String TRUST_STORE_PASSWORD, String KEY_STORE_PASSWORD, String KEY_STORE_LOCATION, String TRUST_STORE_LOCATION) throws IOException, UnrecoverableKeyException, KeyManagementException, KeyStoreException, NoSuchAlgorithmException, CertificateException {

		this.httpStack = new HttpStack(httpPort, TRUST_STORE_PASSWORD,  KEY_STORE_PASSWORD,  KEY_STORE_LOCATION,  TRUST_STORE_LOCATION);
		this.httpStack.setRequestHandler(new RequestHandler() {
			public void handleRequest(Request request) {
				ProxyHttpServer.this.handleRequest(request);
			}
